...
{
    public partial class CinemaBUC : UserControl
    {
        public CinemaBUC()
        {
            InitializeComponent();
        ...
        String sqlquery;
        public int[] bookedseats = new int[15];
        public String[] seatids = new String[15];
        ...
        {
            Array.Clear(bookedseats, 0, 15);
            counter = 0;
            this.Controls.Clear();
            this.InitializeComponent();
            CinemaBUC_Load(this, null);
        }

        private void CinemaBUC_Load(object sender, EventArgs e)
        {
            GetBookedSeats();
            BookedSeats();
        ...
        String[] alreadybookedseatids = new String[15];
        String[] alreadybookedseatnum = new String[15];
        ...
        private void TransactionPanel_Enter(object sender, EventArgs e)
        {
            try
            {
                ...
                sqlquery = "select cinema_name from cinema.CinemaHall where cinema_id = 2";
